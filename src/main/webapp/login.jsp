  ...
  var theEvent = window.event || e;
	...
	$(function(){
		...
		if (explorer.indexOf("MSIE") >= 0) {
		    $("#bulo").removeClass("loginChrome");
		    $("#bulo").addClass("loginBtn");
		}
		//Chrome
		else if(explorer.indexOf("Chrome") >= 0){
		    $("#bulo").removeClass("loginBtn");
		    $("#bulo").addClass("loginChrome");
		}else{
		    $("#bulo").removeClass("loginBtn");
		    $("#bulo").addClass("loginChrome");
		}
	...
	<form action="login" method="post" id="loginForm">
		...
		<DIV
			...
			<P style="margin: 0px 35px 20px 45px;">
				...
				<button id="bulo"  class="loginChrome"  type="button" onclick="login()">登录</button>
			</P>
		</DIV>
	</DIV>
	</form>
