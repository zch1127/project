	...
	<table>
		...
		<tr>
			...
			<td><select id="type" class="easyui-combobox"  style="width: 300px;">
					...
					<option value=2  <c:if test="${offerings.type==2}">selected="true"</c:if>>放生鱼</option>
			</select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<input id="picture"  name="picture" type="text" hidden="1" value="${offerings.imgUrl}" />
		...
		<tr>
			<td>功德币</td>
			<td>
			<input type="text" class="easyui-numberbox"  value="${offerings.meritCoin}" data-options="min:0,precision:0"  id="meritCoin"  style="width: 300px"/>
			</td>
		</tr>
