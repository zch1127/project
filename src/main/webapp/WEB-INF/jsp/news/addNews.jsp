	...
	<table>
		...
		<tr>
			...
			<select id="cateSelect"  class="easyui-combobox"  name="aa" style="width:200px;" data-options="required:true">  
	            ...
	            <option value="2">小型活动</option>
	            <option value="3">大型活动</option>
	            <option value="4">历史活动</option>
		...
		<tr>
			<td>活动地点</td>
			<td>
	           <input name="area" id="bb" class="easyui-combobox" data-options="
		    		valueField:'name',
		    		textField:'name',
		    		url:'${pageContext.request.contextPath }/news/selectArea'
		    		" /><br>
			</td>
		</tr>
		<tr>
			<td>具体地点</td>
			<td>
	           <input name="address" class="easyui-textbox" id="cc">
			</td>
		</tr>
		<tr>
			<td>开始时间</td>
			<td>
			<input class="easyui-datetimebox" id="ksDate" name="publishDate" data-options="required:true,showSeconds:false"
     			style="width:150px">
			</td>
		</tr>
		<tr>
			<td>结束时间</td>
			<td>
			<input class="easyui-datetimebox" id="endDate" name="endDate" data-options="required:true,showSeconds:false"
     			style="width:150px">
			</td>
		</tr>
		<tr>
