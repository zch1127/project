...
public class ArrayUtil {
	...
	public static final Class<? extends Object>[]		EMPTY_CLASS_ARRAY				= new Class<?>[0];
...
//	}
	 ...
	 *            如果数组中的元素为<code>null</code>，则返回此字符串
	 */
	public  static void toString2(StringBuffer buffer, Object array, String nullArrayStr,
									String nullElementStr) {
		if (array == null) {
			buffer.append(nullElementStr);
			return;
